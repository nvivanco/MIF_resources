...
1. Add an image to the registry: `docker build -t registry.git.embl.org/grp-mif/mif_resources/containers/CONTAINER-NAME:v2026.XX.XX .`

1. Push the image to the registry: `docker push registry.git.embl.org/grp-mif/mif_resources/containers/CONTAINER-NAME:v2026.XX.XX`
