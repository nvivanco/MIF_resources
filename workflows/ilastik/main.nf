    ...
    ch_ilastik_inputs = TILE_CONSTRUCTOR.out.tiles
        ...
        .flatMap { meta, tiles_csv, raw_zarr ->
            ...
            tiles_csv.splitCsv(header: true).collect { row ->
                ...
                tile_meta.y_min   = (row.y_min != null && row.y_min != '') ? row.y_min as Integer : null
                tile_meta.y_max   = (row.y_max != null && row.y_max != '') ? row.y_max as Integer : null
                tile_meta.x_min   = (row.x_min != null && row.x_min != '') ? row.x_min as Integer : null
                tile_meta.x_max   = (row.x_max != null && row.x_max != '') ? row.x_max as Integer : null
